...
public:
	...
	/** holds Free Drag menu item*/
	TSharedPtr<FShooterMenuItem> FreeDragItem;
...
protected:
	...
	//取消进入自由拖动模式
	void OnCancelFreeDragMode();
	
	//进入自由拖动模式
	void OnConfirmFreeDragMode(int32 type);
